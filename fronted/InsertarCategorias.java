...
public class InsertarCategorias extends JDialog {
	...
	public InsertarCategorias() {
		...
		lblNombre.setBounds(193, 70, 89, 25);
		contentPanel.add(lblNombre);
		
		txtNombre = new JTextField();
		txtNombre.setBounds(177, 118, 126, 27);
		...
		btnInsertar.setBounds(177, 186, 126, 35);
